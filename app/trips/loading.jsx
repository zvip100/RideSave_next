            ...
            <header className="py-6 border-b border-border">
                <div className="max-w-[1400px] mx-auto px-6 flex justify-between items-center">
                    <div className="flex items-center gap-3">
                        ...
                        <div className="w-28 h-7 rounded-lg bg-secondary animate-pulse" />
                    </div>
                    <div className="w-20 h-5 rounded bg-secondary animate-pulse" />
                </div>
            </header>
            ...
            <div className="max-w-[1400px] mx-auto px-6 py-8">
                ...
                <div className="bg-card border border-border rounded-xl overflow-hidden">
                    ...
                    <div className="border-b border-border px-6 py-4 flex gap-6">
                        {['w-16', 'w-40', 'w-20', 'w-24', 'w-24', 'w-32'].map((width, i) => (
                            <div
                                key={i}
